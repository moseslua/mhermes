...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("specialist", "Manage domain specialists", "Tools & Skills",
               aliases=("spec",), args_hint="[create|list|edit|delete|show]",
               subcommands=("create", "list", "edit", "delete", "show")),
